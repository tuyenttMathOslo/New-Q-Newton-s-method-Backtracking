...
def f47Hessian(z):
    ...
    ########### f48: x^4+y^4, degenerate critical point #################
######## Global minimum (0,0).
...
####################
    ...
    ########### f49: \sum q_{i,j}x_i^2x_j^2, degenerate critical point #################
######## Global minimum (0,0).

def f49(z):
    x1,x2,x3=z
    tmp=qMatrix[0][0]*(x1**2)*(x1**2)+qMatrix[0][1]*(x1**2)*(x2**2)+qMatrix[0][2]*(x1**2)*(x3**2)+qMatrix[1][1]*(x2**2)*(x2**2)+qMatrix[1][2]*(x2**2)*(x3**2)+qMatrix[2][2]*(x3**2)*(x3**2)
    return tmp
...
####################
    ...
    ########### f50: Monkey saddle point x^3-3xy^2 #################
######## No global minimum
...
####################
    ...
    ########### f52: (x^2y+y^2)t Modification of  x^2y+y^2 #################
######## No global minimum.
...
def NewQNewtonPlusV1():

    print("10. New Q Newton's method Plus V1:")
...
def NewQNewtonPlusV2():

    print("12. New Q Newton's method Plus V2:")
...
def NewQNewtonPlusV3():

    print("10. New Q Newton's method Plus V3:")
...
def NewQNewtonPlusV4():

    print("12. New Q Newton's method Plus V4:")
...
#Random NewQNewtonPlusV1
def RandomNewQNewtonPlusV1():

    print("11. Random New Q Newton's method Plus V1:")
...
#RandomNewQNewtonPlusV2

def RandomNewQNewtonPlusV2():

    print("13. Random New Q Newton's method Plus V2:")
...
qMatrix=10*np.random.rand(dimN,dimN)-10*np.random.rand(dimN,dimN)
...
z00_old=0.001*np.array([2*np.random.rand()-1 for _ in range(dimN)])
#z00_old=np.array([-0.00233109,  0.00233109])
